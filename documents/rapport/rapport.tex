				...
				\subsection{Fonctionnement technique}
					...
					\subsubsection{\textcolor{blue}{Fonctions d'étalonnage}}
						...
						\paragraph{Binarisation} \paragraph{}
							...
							Enfin, avant de retourner cette nouvelle image, on applique sur cette image une série de fermeture. Le principe de la fermeture est d'appliquer une érosion puis une dilatation des formes blanches obtenues. L'interêt de cet action est d'éliminer les éventuells pixels blancs solitaires sur l'image, de manière à diminuer au maximum les parasites sur l'image qui viendrai fausser les opérations à venir.
