...
\begin{document}
	...
	\section{Introduction}
		...
		But du projet :
		\begin{itemize}
		\item Concevoir une application utilisable avec des seuls gestes (sans souris)
		\item Développer une librairie de détection d'objet dans une image
		\item Exploiter cette librairie pour reconnaitre les mouvements de l'utilisateur
	...
	% Geoffrey pour la conclusion avec Kevin éventuellement
	\section{Conclusion}
