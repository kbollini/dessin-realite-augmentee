	...
	\section{Librairie}
		...
		\begin{frame}{Suivi par couleur : Composante connexe}
			\begin{itemize}
				...
				\item{Sélection de la composante correspondante au curseur}
				\item{Récuperation de son barycentre} 
			\end{itemize}
		\end{frame}
		...
		\begin{frame}{Comparatifs Couleur/Forme}
		\pause
			\begin{block}{Couleur}
				Avantages \\
				- Traçage rapide \\
			...
			\begin{block}{Forme}
				...
				- Étallonnage plus simple \\
				Faiblesses \\
				- Traçage lent \\
				- Sensible à la qualité du curseur\\
			\end{block}
		\end{frame}
		\begin{frame}{Comparatifs Simple/composante connexe}
		\pause
			\begin{block}{Barycentre simple}
				...
				- Précision dépendante fortement de l'environnement\\
			\end{block}
			\pause
