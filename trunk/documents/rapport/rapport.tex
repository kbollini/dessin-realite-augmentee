...
\begin{document}
	...
	\chapter{Introduction}
      ...
      %en pensez quoi? il faut qu'avec juste ces qq lignes, n'importe qui comprenne le sujet
		L'objectif de ce projet est de créer un tableau numérique, sur lequel ou une plusieurs personnes peuvent dessiner en réalisant directement les gestes comme sur une toile réelle. \\
		Pour cela nous utiliserons une interface basée sur la reconnaissance des mouvements detectés par la webcam.
