...
\begin{document}
	...
	\chapter{Introduction}
		...
		Les cinq dernières années ont marqué un grand renouveau dans les interfaces entre hommes et terminaux (écrans tactiles, contrôles vocaux, détection de mouvements). Cet état de faits nous a amené à penser une application mettant en scène l'une de ces nouvelles façons d'interagir.\\
